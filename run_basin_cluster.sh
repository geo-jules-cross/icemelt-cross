...
sed -i.SEDBACKUP "s/.*tempadd.*/tempadd = 2.0/" $NL.bwall
# sed -i.SEDBACKUP "s/.*windmult.*/windmult = 0.67/" $NL.bwall
sed -i.SEDBACKUP "s/.*windmult.*/windmult = 0.1/" $NL.bwall
...
sed -i.SEDBACKUP "s/.*tempadd.*/tempadd = 5.0/" $NL.bfloor
# sed -i.SEDBACKUP "s/.*windmult.*/windmult = 0.33/" $NL.bfloor
sed -i.SEDBACKUP "s/.*windmult.*/windmult = 0.05/" $NL.bfloor
